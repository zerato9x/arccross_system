...
An AI agenda that dictates the entity will flee immediately if the player's Threat is strictly greater than the entity's Will.

### Belligerent

**Status:** Established

An AI agenda that dictates the entity will fight until severely crippled or out-Threatened.

### Zealot

**Status:** Established

An AI agenda that dictates the entity will ignore Threat calculations entirely and fight to the bitter end.

### Mindless

**Status:** Established

An AI agenda representing a complete lack of self-preservation, causing the entity to ignore Threat calculations completely.
...
A non-duel action classified as a Minor action that performs standard traversal forward through the 12-lane matrix.

### Move Backward

**Status:** Established

A non-duel action classified as a Minor action that performs standard traversal backward through the 12-lane matrix.

### Charge

**Status:** Established

A non-duel action classified as a Heavy action that sprints two cells forward. It carries a Grapple Intercept risk when executed at a distance of 1.

### Shoot

**Status:** Established

A non-duel action classified as a Major action that fires a ranged weapon at a random body part.

### Aimed Shot

**Status:** Established

A non-duel action classified as a Heavy action that fires a ranged weapon at a specific target limb.

### Cycle

**Status:** Established

A non-duel action classified as a Quick action to manually cycle a rifle bolt between shots.

### Reload

**Status:** Established

A non-duel action classified as a Minor action that refills a pistol's internal magazine using backpack ammunition.

### Object Interact

**Status:** Established

A non-duel action classified as a Major action that interacts with an object at any tile.

### Use Item

**Status:** Established

A non-duel action classified as a Minor action that consumes or applies an item from the entity's backpack.

### Take Cover

**Status:** Established

A non-duel action classified as a Major action that drops the entity's profile. It intentionally sets the entity's Stance State to Stumbling and grants an evasion bonus.

### Strike

**Status:** Established

A duel-locked action classified as a Major action serving as the core weapon attack aiming for flesh and limb damage. It explicitly prevents Head targeting.

### Grapple

**Status:** Established

A duel-locked action classified as a Heavy action that forces both engaged entities into a Felled Stance State, opening a reaction window for an Execute action.

### Push Stay

**Status:** Established

A duel-locked action classified as a Major action that resolves a leverage check to displace the enemy one cell away while the initiator stays in place, breaking the Melee Lock.

### Push Follow

**Status:** Established

A duel-locked action classified as a Major action that resolves a leverage check to displace the enemy one cell away while the initiator follows, maintaining the Melee Lock.

### Pull Follow

**Status:** Established

A duel-locked action classified as a Major action that resolves a leverage check to drag the enemy one cell closer while the initiator steps back, maintaining the Melee Lock.

### Pull Stay

**Status:** Established

A duel-locked action classified as a Major action that resolves a leverage check to drag the enemy one cell closer while the initiator stays in place, breaking the Melee Lock.

### Break

**Status:** Established

A duel-locked action classified as a Major action representing a braced stance attack that erodes the opponent's Stance Points without inflicting flesh damage.

### Disengage

**Status:** Established

A duel-locked action classified as a Heavy action representing a desperate attempt to tear away and escape from an active Melee Lock.

### Trip

**Status:** Established

A prone window action classified as an All AP action that acts as a ground sweep requiring a dexterity check to pull a standing opponent into a Felled state.

### Get Up

**Status:** Established

A prone window action classified as an All AP action that acts as an emergency tax to clear a Felled state and restore Stance Points to their maximum.

### Execute

**Status:** Established

A prone window action classified as a Minor action that performs an instant kill on a Felled opponent located in the exact same grid slot.

### Block

**Status:** Established

An off-turn reaction classified as a Minor action that absorbs an incoming Strike. It requires a shield or a functional arm.

### Dodge

**Status:** Established

An off-turn reaction classified as a Minor action that evades ranged or melee attacks using the Finesse Pillar. It is disabled if the entity's legs are destroyed.

### Stay

**Status:** Established

An off-turn reaction classified as a Free action triggered after a successful Push. The initiator holds their position, successfully breaking the Melee Lock.

### Follow

**Status:** Established

An off-turn reaction classified as a Free action triggered after a successful Push. The initiator steps into the vacated slot, maintaining the Melee Lock.
...
An AI combat tactic that heavily weights Shoot, Disengage, and Take Cover actions, as the entity seeks to maintain maximum distance.

### Brute

**Status:** Established

An AI combat tactic that heavily weights Charge, Grapple, and Push Follow actions, as the entity seeks to force and maintain Melee Locks.

### Opportunist

**Status:** Established

An AI combat tactic that avoids direct strikes unless the opponent is Stumbling or Felled, frequently utilizing the Trip action.

### Defender

**Status:** Established

An AI combat tactic that heavily weights Move Backward to become a braced support, frequently utilizing the Block reaction.
...
A passive lane structural surface evaluated by `CombatRules`. It includes specific mechanics such as Trees (increasing dodge chances) and Mud (increasing AP movement costs).

### Tile Object

**Status:** Established, CombatCore-private

A destructible environmental object placed into grid cells to disrupt lane lines. Evaluated by `CombatRules`, it includes mechanics such as Cover (providing hit-chance mitigation), Obstacles (requiring AP to bypass), and Traps (exploding upon interaction).
